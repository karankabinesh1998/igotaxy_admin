      ...
      <div class="main-content">
        ...
        <ModelWindow
          ...
          ButtonBody={
            <React.Fragment>
              <h3>Cab Details</h3>
              <p>Cab Number Plate</p>
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.cab_image_front}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
              ...
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-2">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.cab_image_back}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
              ...
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.cab_image_side}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
              ...
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.cab_insurance}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
