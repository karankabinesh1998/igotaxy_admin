            ...
            <React.Fragment>
              ...
              <div className="row form-group">
                ...
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.driver_image}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
              ...
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.driving_license_front}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
              ...
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.driving_license_back}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>

              <h4>Police Verify certificate</h4>
              <div className="row form-group">
                <div className="col-sm-2" />
                <div className="col-sm-8">
                  <img width={300} height={200} alt="Upload the image" src={`${ACCESS_POINT}/admin/vendarfile/${this.state.ViewDocData.police_verify}/${this.state.ViewDocData.vendor}`} />
                </div>
                <div className="col-sm-2" />
              </div>
