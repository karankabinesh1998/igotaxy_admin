...
class AddTrips extends React.Component {
  constructor(props) {
    super(props)
    {
      this.state =
      {
        ...
        cabTypeOption: [
          { value: 1, label: "Any Sedan" }, { value: 2, label: "Suv" }, { value: 3, label: "Innova" },
          { value: 4, label: "Sedan" }, { value: 5, label: "Swift dzire" }, { value: 6, label: "Toyota Etios" },
          { value: 7, label: "Tata zest" }, { value: 8, label: "Tavera" }, { value: 9, label: "Xylo" },
          { value: 10, label: "Innova" }, { value: 11, label: "Innova crysta" }, { value: 12, label: "Tata Indica" },
          { value: 13, label: "Etios liva" }, { value: 14, label: "Nissan Sunny" }, { value: 15, label: "Tempo traveller 12+1" },
          { value: 16, label: "Mahindra marazzo" }, { value: 17, label: "Chevrolet enjoy" }, { value: 18, label: "Coach 407" },
        ],
  ...
  submit = async () => {
    const { username, mobile, alternate_mobile, trip_kms, trip_charges, email_id, address, selectedcustomer, selectedDropLocationOption, selectedPickupLocationOption,
      ...
      parking, toll_plaza, night_drop_up, night_pick_up,permit
    } = this.state;
                ...
                data-target="#addvendar">
                    ...
                    <div class="card-body">
                      ...
                      <div className="row form-group">
                        <div className="col-sm-2"></div>
                        <div className="col-sm-2">
                          <label class="labell2">Permit Charges</label>
                        </div>
                        <div className="col-sm-4">
                          <SingleSelect
                            options={this.state.includesExcludes}
                            handleChange={d => this.HandlePermit(d)}
                            selectedService={this.state.permit}
                          />
                        </div>
                        <div className="col-sm-3"> <span class="errormsg">{this.state.errorcabTypeOption}</span> </div>
                      </div>
