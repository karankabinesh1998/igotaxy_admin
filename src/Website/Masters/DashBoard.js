      ...
      if(Object.keys(dashBoard.data).length){
        // console.log(dashBoard.data);
         this.setState({
           ...
           overAllTotalAmount:dashBoard?.data?.overAllTotalAmountRecieved?.[0]?.total ? dashBoard?.data?.overAllTotalAmountRecieved?.[0]?.total  : 0
         })
      }
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total Amount Recieved Today</h5>
                          <h2 class="mb-3 font-18">{this.state.overAllTotalAmount}</h2>
                          {/* <p class="mb-0"><span class="col-green">42%</span> Increase</p> */}
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
