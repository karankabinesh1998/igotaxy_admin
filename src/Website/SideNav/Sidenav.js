...
import Logo from "../images/igotaxy_logo.jpg";
// import $ from "jquery";
import {AiOutlineDashboard ,AiOutlineCar, AiOutlineFolderAdd} from 'react-icons/ai';
    ...
    render(){
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href={'/dashboard'}> <img alt="image" src={Logo} class="header-logo" /> <span
                class="logo-name">igoTaxy</span>
            </a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="/dashboard" class="nav-link"><AiOutlineDashboard size={24} style={{width:'20px',color:'black'}}/><span class="Sidenav">Dashboard</span></a>
            </li>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"> <AiOutlineFolderAdd size={24} style={{width:'20px',color:'black'}}/> <span class="Sidenav"> Add Masters </span></a>
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" id="anchorid" href={'/announcement'}>Add Announcement</a></li>
                {/* <li><a class="nav-link" id="anchorid" href={'/city'}>Add City</a></li> */}
            ...
            <a href="#" class="menu-toggle nav-link has-dropdown"> <AiOutlineCar size={24} style={{width:'20px',color:'black'}} /> <span  class="Sidenav"> Trips Master </span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" id="anchorid" href={`/trip`}>Add Trip Master</a></li>
                <li><a class="nav-link" id="anchorid" href={`/assignTrip`}>Assign Trip to Vendor</a></li>
                <li><a class="nav-link" id="anchorid" href={`/activetrip`}>Active Trip</a></li>
